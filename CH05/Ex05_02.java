 ...
 *  Revise the program to generate ten random addition questions for two integers
 *  between 1 and 15. Display the correct count and test time.
 *
 */
...
public class Ex05_02 {
   public static void main(String[] args) {
      ...
      int count = 0; // Count the number of quetions
      ...
      while (count < NUMBER_OF_QUESTIONS) {  
         ...
         // 2. Prompt the student to answer "number1 + number2"
